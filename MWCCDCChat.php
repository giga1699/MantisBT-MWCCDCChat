...
class MWCCDCChatPlugin extends MantisPlugin {
    ...
    function notify($msg, $channel, $channelTopic) {
        ...
        $ch = curl_init();
        $url = sprintf('https://%s:%s@%s/api/v1/messages', plugin_config_get('bot_email'), plugin_config_get('bot_token'), plugin_config_get('chat_domain'));
